  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-3 mb-6">
        <h4 className="text-sm font-medium text-gray-700">Database Cache Management</h4>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          >
            {isClearing ? 'Clearing...' : 'Clear Database Cache'}
          </button>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-md">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          <li>• Games load slower due to complex JSON data - cached for 5 seconds</li>
          <li>• Images are loaded directly from disk without caching</li>
          <li>• Clear database cache if you notice stale data</li>
